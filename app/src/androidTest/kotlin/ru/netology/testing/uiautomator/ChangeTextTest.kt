...
//    }
    ...
    fun testEmptyText() {
        ...
        device.findObject(By.res(packageName, "userInput")).text = blankText
        device.findObject(By.res(packageName, "buttonChange")).click()

        val result = device.findObject(By.res(packageName, "textToBeChanged")).text
        var defaultText: String =
            ApplicationProvider.getApplicationContext<Context>().getString(R.string.hello_world)
        assertEquals(result, defaultText)
    ...
    fun runSecondActivity() {
        ...
        waitForPackage(packageName)
        val result: String = device.findObject(By.res(packageName, "text")).text
        assertEquals(result, textToSet)
